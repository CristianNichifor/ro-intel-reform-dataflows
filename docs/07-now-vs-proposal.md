...
| **SPP** — Protection & Guard | Under presidential authority; checked only by the weak defence committees — no dedicated committee, no subpoena; unwarranted protection records (C11–C13) | Joins the warrant regime (W3); IG full audit access (T20); ANSPDCP high-risk notifications (T21); JPC subpoena power extends to it (T18c); direct presidential reporting channel closed |
